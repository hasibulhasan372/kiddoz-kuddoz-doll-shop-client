        ...
        <div className="hero lg:h-[400px] " style={{ backgroundImage: `url("https://i.ibb.co/1Jv7SHr/pexels-skylar-kang-6045113.jpg")` }}>
            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="max-w-xl">
                    ...
                    <p className="mb-5 ">We are the number one Doll shop in the city. You are are welcome to our shop to buy the best liked and trending toys for your child</p>
                    <Link to="/allToys" className="secondary-btn capitalize">All Toys</Link>
                </div>
            </div>
        </div>
    );
