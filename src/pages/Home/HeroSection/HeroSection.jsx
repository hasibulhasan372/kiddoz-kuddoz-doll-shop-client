...
const HeroSection = () => {
    return (
        <div className="hero " style={{ backgroundImage: `url("https://i.ibb.co/1Jv7SHr/pexels-skylar-kang-6045113.jpg")` } }>
            <div className="hero-overlay bg-opacity-70"></div>
            <div className="hero-content text-center text-neutral-content py-20">
                <div className="">
                    <h1 className="mb-5 lg:leading-[70px] lg:text-5xl font-bold text-purple-300" 
