...
const About = () => {
    return (
        <div className="my-con py-10 lg:py-12 text-center lg:text-left ">
            <h1 className="main-text-color text-center font-bold text-xl lg:text-3xl"
            data-aos="fade-down-right" data-aos-duration="1500" data-aos-delay="50" data-aos-easing="ease-in-out"
            >About Us </h1>
            <div className="grid md:grid-cols-2 mt-6 lg:mt-12 items-center gap-6 lg:gap-10">
                    <div data-aos="fade-down-left" data-aos-duration="1500" data-aos-delay="50" data-aos-easing="ease-in-out">
                        <img src="https://cdn.shopify.com/s/files/1/1152/4590/files/2.png" alt="" className="w-[240px] lg:w-full inline-block" />
                    </div>
