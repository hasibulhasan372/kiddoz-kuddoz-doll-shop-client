    ...
    return (
        <div className="lg:py-20 py-10">
            <div className="my-con">
                <h1 className=" text-xl lg:text-3xl main-text-color lg:font-bold text-center pb-6 lg:py-12 font-serif" data-aos="fade-down-right" data-aos-duration="1500" data-aos-delay="50" data-aos-easing="ease-in-out">What Our Customer Says</h1>
                ...
                >
                    {
                        feedbacks.map(feedback => <div
                            ...
                            key={feedback._id}
                            className="border p-3 lg:p-4 rounded-ee-[60px] bg-sky-50  rounded-ss-[60px]"
                        >
